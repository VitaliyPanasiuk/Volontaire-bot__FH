...
psychological_help_router = Router()


@psychological_help_router.callback_query(lambda c: c.data == 'psychological help')
async def user_start(callback_query: types.CallbackQuery):
    
    userid = callback_query.from_user.id
    await user_update.update_action(userid, 'psychological help')
